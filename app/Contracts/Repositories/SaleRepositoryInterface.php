...
interface SaleRepositoryInterface
{
     ...
     * @return array{total_amount: int, count: int, average_amount: int, by_payment: list<array{method: string, count: int, total: int}>}
     */
    ...
    /**
     * @return array{total_amount: int, count: int, by_payment: list<array{method: string, count: int, total: int}>, daily: list<array{date: string, total: int, count: int}>}
     */
    public function reportBetween(Store $store, CarbonInterface $from, CarbonInterface $to): array;

    /**
     * @return list<array{product_id: int, name: string, quantity: int, revenue: int}>
     */
